...
namespace CymmetriLoginSDKLibrary21.apicalls
{
    ...
    public class MfaFlowResponseData
    {
    ...
    class MfaFlow
    {
        ...
        public MfaFlow(HttpClient httpClient, string currentToken)
        {
        ...
        public async Task<string> MakeRequest()
        {
            ...
            SetClientHeaders();
            var response = await httpClient.PostAsync("authsrvc/auth/mfaFlow", data);
